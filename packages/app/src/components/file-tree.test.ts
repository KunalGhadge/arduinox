...
beforeAll(async () => {
  ...
  mock.module("@arduinox-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@arduinox-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@arduinox-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@arduinox-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
