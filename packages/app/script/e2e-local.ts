...
const keepSandbox = process.env.ARDUINOX_E2E_KEEP_SANDBOX === "1"

const serverEnv = {
  ...process.env,
  OPENCODE_DISABLE_SHARE: process.env.ARDUINOX_DISABLE_SHARE ?? "true",
...
const runnerEnv = {
  ...
  VITE_ARDUINOX_SERVER_HOST: "127.0.0.1",
  VITE_ARDUINOX_SERVER_PORT: String(serverPort),
