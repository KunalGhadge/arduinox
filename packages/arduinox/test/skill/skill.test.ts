...
`,
  ...
  const home = process.env.ARDUINOX_TEST_HOME
  process.env.ARDUINOX_TEST_HOME = tmp.path
  ...
  try {
    ...
    process.env.ARDUINOX_TEST_HOME = home
  }
})
...
test("discovers global skills from ~/.claude/skills/ directory", async () => {
  ...
  const originalHome = process.env.ARDUINOX_TEST_HOME
  process.env.ARDUINOX_TEST_HOME = tmp.path
  ...
  try {
    ...
    process.env.ARDUINOX_TEST_HOME = originalHome
  }
})
