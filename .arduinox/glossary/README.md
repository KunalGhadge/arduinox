...
Use this folder for locale-specific translation guidance that supplements `.ArduinoX/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/ArduinoX/pull/12345

## Do Not Translate (Locale Additions)

- `ArduinoX` (preserve casing)
